...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    if (this.counter === undefined || this.index !== index) this.counter = 0 /*si counter est undefined ou l'index ne correspond pas counter = 0 et supprime la liste*/
    ...
    /*bug 4 - si l'élément n'a pas de listener on l'ajoute*/
    bills.forEach((bill) => {
